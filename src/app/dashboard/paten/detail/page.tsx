    ...
    return (
        <>
            <section className="bg-white  font-poppins">
                <div className="grid max-w-screen-xl p-8 mx-auto lg:gap-8 xl:gap-0  lg:grid-cols-1">
                    <div>
                        <div className="w-64">
                                ...
                                <div className="bg-white">
                                    <div className="mx-auto grid max-w-2xl grid-cols-1 items-center gap-x-8 gap-y-16 px-4 py-24 sm:px-6 sm:py-8 lg:max-w-7xl lg:grid-cols-2 lg:px-8">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-[#1D6363] text-2xl md:text-5xl">
                        ...
                        <div className="mt-4 bg-white">
                            <div className="p-8 pb-4 pt-4 border-b border-[#EBE9F6]">
                                <div className="bg-white">
                                    <div>
