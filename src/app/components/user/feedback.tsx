    ...
    return (
        <section className="bg-white py-16">
            ...
            <div className="mx-auto grid max-w-screen-xl px-8 pt-8 lg:grid-cols-12 lg:gap-8 lg:py-16 xl:gap-0">
                <div className="m-auto lg:col-span-12 text-center">
            ...
            <form onSubmit={handleSubmit} className="mx-auto grid max-w-screen-xl px-8 lg:grid-cols-2 gap-8 lg:pb-16">
                <div className="mb-2 mt-4">
                    <label className="mb-2 block font-poppins text-sm font-medium text-[#111827]" htmlFor="nama">
                        Nama
                    </label>
                    <input
                        required
                ...
                <div className="mb-2 mt-4">
                    <label className="mb-2 block font-poppins text-sm font-medium text-[#111827]" htmlFor="instansi">
                        Instansi
                    </label>
                    <input
                        required
                ...
                <div className="mb-2 mt-4">
                    <label className="mb-2 block font-poppins text-sm font-medium text-[#111827]" htmlFor="kontak">
                        Kontak
                    </label>
                    <input
                        required
                ...
                <div className="mb-2 mt-4">
                    <label className="mb-2 block font-poppins text-sm font-medium text-[#111827]" htmlFor="usulan">
                        Usulan
                    </label>
                    <textarea
                        required
