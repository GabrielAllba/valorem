...
const NavigationBar = () => {
  ...
  return (
    <>
      ...
      <Disclosure
        as="nav"
        className="fixed z-10 w-full border-b border-[#ECECEC] bg-white font-poppins"
      >
        {({ open }) => (
          <>
                    ...
                    <div className="flex space-x-4">
                      {navigation.map((item) =>
                        !item.children ? (
                          ...
                          <Menu as="div" className="relative ml-3 flex items-center" key={item.id}>
                            <div>
                          ...
                          <Menu as="div" className="relative ml-3 flex items-center" key={item.id}>
                            <div>
                              <Menu.Button className="relative flex rounded-full bg-white  focus:outline-none ">
                                <p className=" flex items-center rounded-xl px-3 py-2  text-black hover:bg-[#1D6363] hover:text-white">
                                  <span className="pr-2">
                                    {item?.children?.find((child) => child.name === language)?.icon}
                                  </span>
