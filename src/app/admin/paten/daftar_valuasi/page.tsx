...
export default function DaftarValuasiPatenAdmin() {
    ...
    return (
        <Root sx={{ maxWidth: '100%', width: '100%' }} className="text-black bg-white shadow-lg">
                                ...
                                <tr key={row.no_valuasi}>
                                    ...
                                    <td>
                                        {row.nilai_valuasi === 'Menunggu Valuasi' ? (
                                            <p className="w-fit flex items-center rounded-md bg-[#F8F3EE] px-2 py-1 text-xs font-medium text-[#DD9246] ring-1 ring-inset ring-[#F4DEC9] font-poppins">
                                                {row.nilai_valuasi}
                                            </p>
                                        ) : (
                                    ...
                                    <td style={{ width: 'auto' }} align="right" className="flex items-center m-auto">
                                        <Link
                                            href="/admin/paten/detail"
                                            className="flex items-center rounded-md bg-green-50 px-2 py-1 text-xs font-medium text-green-700 ring-1 ring-inset ring-green-600/20 font-poppins "
                                        >
                                            Lihat Detail
                                        </Link>
                                    </td>
...
function createData(no_valuasi: string, nama_paten: string, jenis_paten: string, nilai_valuasi: string) {
