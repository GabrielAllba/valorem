...
export default function DetailPatenAdmin() {
    return (
        <>
            <section className="bg-white  font-poppins">
                <div className="grid max-w-screen-xl mx-auto lg:gap-8 xl:gap-0  grid-cols-1">
                    <div>
                        <div className="p-4">
                        ...
                        <div className="mt-4 bg-white">
                            <div className="p-4 pt-4 border-b border-[#EBE9F6]">
                                <div className="bg-white">
                                    <div>
