...
const DetailHakCiptaAdmin = () => {
  return (
    <>
      <section className="bg-white  font-poppins">
        <div className="mx-auto grid max-w-screen-xl grid-cols-1 p-2 lg:gap-8 xl:gap-0">
          <div>
            <div className="p-4">
            ...
            <div className="mt-4 bg-white">
              <div className="border-b border-[#EBE9F6] p-4 pb-4 pt-4">
                <div className="bg-white">
                  <div>
...
export default DetailHakCiptaAdmin;
